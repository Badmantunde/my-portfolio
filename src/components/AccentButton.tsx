...
const baseClass =
  'group inline-flex items-center gap-2 bg-[#15803d] hover:bg-[#166534] text-white text-[13px] sm:text-[14px] rounded-full pl-5 sm:pl-6 pr-2 py-2 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]'
  ...
  return (
    <>
      ...
      <span className="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 bg-white rounded-full transition-transform duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)] group-hover:-rotate-45">
        {icon ?? <ArrowRight size={16} className="text-[#15803d]" />}
      </span>
    </>
  )
}
